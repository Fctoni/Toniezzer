...
1. **Leia o arquivo de padrões**: `.claude/padroes-codigo.md` — contém todos os padrões obrigatórios
2. **Siga os padrões definidos**: services com DI, funções puras, assinatura padronizada

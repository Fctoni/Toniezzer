  ...
  public: {
    Tables: {
      ...
      tarefas_comentarios: {
        ...
        Relationships: [
          {
            foreignKeyName: "tarefas_comentarios_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      tarefas_dependencias: {
        ...
        Relationships: [
          {
            foreignKeyName: "tarefas_dependencias_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "tarefas_dependencias_depende_de_tarefa_id_fkey"

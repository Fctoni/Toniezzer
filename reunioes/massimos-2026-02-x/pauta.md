# Assuntos urgentíssimos para resolver nesta reunião.

Pontos importantes que temos que levar em consideração.

- Na tecnologia construtiva que estamos utilizando, a infraestrutura da casa (elétrica, hidráulica e esgoto) é feita no início, ao contrário da alvenaria, que é no final.
- Planejamento evita retrabalhos, atrasos, custos, quebradeira e remendos.
- As equipes de obra necessitam de documentos físicos, com cotas bem definidas, fáceis de interpretar e com o mínimo de 'uso de calculadora' possível. Um projeto 3d no computador não é viável para as equipes de obra. 
- Whatsapp não funciona para envio de documentos importantes / orçamentos, etc. Sugestão: criar um drive compartilhado para nossa obra
